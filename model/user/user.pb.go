...
type GreetingRequest struct {
	...
	Salutaion string `protobuf:"bytes,2,opt,name=salutaion,proto3" json:"salutaion,omitempty"`
}
...
func (x *GreetingRequest) GetSalutaion() string {
	if x != nil {
		return x.Salutaion
	}
	return ""
...
var file_proto_user_proto_rawDesc = []byte{
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0c, 0x5a, 0x0a, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x75,
...
var file_proto_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.GetHello:input_type -> user.GreetingRequest
	1, // 1: user.UserService.GetHello:output_type -> user.GreetingResponse
...
type UserServiceClient interface {
	GetHello(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (*GreetingResponse, error)
}
...
func (c *userServiceClient) GetHello(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (*GreetingResponse, error) {
	out := new(GreetingResponse)
	err := c.cc.Invoke(ctx, "/user.UserService/GetHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	GetHello(context.Context, *GreetingRequest) (*GreetingResponse, error)
}
...
func (*UnimplementedUserServiceServer) GetHello(context.Context, *GreetingRequest) (*GreetingResponse, error) {
...
func _UserService_GetHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreetingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.UserService/GetHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetHello(ctx, req.(*GreetingRequest))
	}
...
var _UserService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetHello",
			Handler:    _UserService_GetHello_Handler,
		},
	},
